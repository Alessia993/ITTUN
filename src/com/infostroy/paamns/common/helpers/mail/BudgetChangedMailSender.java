 ...
 * 
 */
public class BudgetChangedMailSender extends MailSender
{

	/**
	 * @param info
	 */
	public BudgetChangedMailSender(List<InfoObject> info)
	{
		super(info);
	}
