...
public class LocalizationMailSender extends MailSender
{

	/**
	 * @param info
	 */
	public LocalizationMailSender(List<InfoObject> info)
	{
		super(info);
