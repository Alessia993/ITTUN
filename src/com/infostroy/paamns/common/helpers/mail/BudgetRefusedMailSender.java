 ...
 * 
 */
public class BudgetRefusedMailSender extends MailSender
{
	/**
	 * @param info
	 */
	public BudgetRefusedMailSender(List<InfoObject> info)
	{
		super(info);
