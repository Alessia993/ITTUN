...
public class Documents extends
        com.infostroy.paamns.persistence.beans.entities.PersistentEntity
{
     ...
     * @param signflag
     */
    public Documents(String title, String name, Users user, Date documentDate,
            String protocolNumber, Sections section, Projects project,
            String fileName, Category category, String signflag)
    {
        super();
        this.title = title;
        this.name = name;
    ...
    public Documents(String title, String name, Users user, Date documentDate,
            String protocolNumber, Sections section, Projects project,
            String fileName, Category category, boolean isPublic, int role, String signflag)
    {
        super();
        this.title = title;
        this.name = name;
    ...
    public Documents(String title, String name, Users user, Date documentDate,
            ...
            Long documentNumber, String note, Date editableDate, String signflag)
    {
        super();
        this.title = title;
        this.name = name;
    ...
    public Documents(String title, String name, Users user, Date documentDate,
            String protocolNumber, Sections section, Projects project,
            String fileName, Category category, boolean isPublic, String signflag)
    {
        super();
        this.title = title;
        this.name = name;
    ...
    public Documents(String title, String name, Users user, Date documentDate,
            String protocolNumber, Sections section, Projects project,
            String fileName, Category category, boolean isPublic, Users partner, String signflag)
    {
        super();
        this.title = title;
        this.name = name;
    ...
    /**
     * Stores signflag value of entity.
     */
    @Column(name = "sign_flag")
    private String            signflag;
    
    /**
     * Stores hashfile value of entity.
     */
	...
	public String getUserRoles()
	{
		if (this.getUser() != null)
		{
			try
			{
				if (this.getUser().getRolesNames() != null)
				{
					return this.getUser().getRolesNames().replace("CIL", "REV");
				}
			}
			catch (PersistenceBeanException e)
			{
	...
	/**
	 * Gets loadingDate
	 * @return loadingDate the loadingDate
	 */
