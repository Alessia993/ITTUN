...
@Entity
@Table(name = "additional_fesr_cf_info")
public class AdditionalFesrCFInfo extends PersistentEntity {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4526869688554694674L;
