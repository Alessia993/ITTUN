 ...
 *
 */
public class ProceduresBean extends PersistenceEntityBean<Procedures>
{
    @SuppressWarnings("unchecked")
    public List<Procedures> LoadByProject(String projectId)
            throws HibernateException, NumberFormatException,
            PersistenceBeanException
    {
        return PersistenceSessionManager.getBean().getSession()
                .createCriteria(Procedures.class)
    ...
    @SuppressWarnings("unchecked")
    public List<Procedures> LoadLastByProject(String projectId)
            ...
            throws PersistenceBeanException
    {
        ...
        sb.append("Select Max(version) FROM Procedures p ");
        sb.append("WHERE p.project.id = :projectId AND p.deleted = false ");
    ...
    @SuppressWarnings("unchecked")
    public List<Procedures> LoadByProgressValidationObject(
