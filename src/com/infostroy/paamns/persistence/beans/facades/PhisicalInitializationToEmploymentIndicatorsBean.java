 ...
 *
 */
public class PhisicalInitializationToEmploymentIndicatorsBean extends
        PersistenceEntityBean<PhisicalInitializationToEmploymentIndicators>
{
            ...
            throws PersistenceBeanException
    {
        ...
        if (idss.length > 0)
        {
            List<PhisicalInitializationToEmploymentIndicators> list = PersistenceSessionManager
                    .getBean()
                    .getSession()
                    .createCriteria(
                            PhisicalInitializationToEmploymentIndicators.class)
                    .add(Restrictions.in("phisicalInitialization.id", idss))
                    .list();
            
            List<Long> ids = new ArrayList<Long>();
            for (PhisicalInitializationToEmploymentIndicators item : list)
            {
    ...
    public void DeleteAll(String projectId)
    {
        ...
        try
        {
            ...
            sb.append(PhisicalInitializationToEmploymentIndicators.class
                    .getSimpleName());
    ...
    @SuppressWarnings("unchecked")
    public List<PhisicalInitializationToEmploymentIndicators> getByProject(
            ...
            HibernateException, NumberFormatException, PersistenceBeanException
    {
        ...
        {
            return new ArrayList<PhisicalInitializationToEmploymentIndicators>();
        }
    }
    
    @SuppressWarnings("unchecked")
    public List<PhisicalInitializationToEmploymentIndicators> LoadLastByProject(
            String projectId) throws PersistenceBeanException
    {
        Long[] ids = BeansFactory.PhisicalInizializations().GetByProject(
                projectId);
    ...
    @SuppressWarnings("unchecked")
    public List<PhisicalInitializationToEmploymentIndicators> LoadByProgressValidationObject(
    ...
    {
        StringBuilder sb = new StringBuilder();
        sb.append("Select Max(version) FROM PhisicalInitializationToEmploymentIndicators p ");
