 ...
 *
 */
public class ProgramRealizationIndicatorsBean extends
        ProgramIndicatorsBean<ProgramIndicators>
{
    ...
    {
        return super.Load(ProgramIndicatorsType.Realization);
    }
    ...
    public static List<ProgramIndicators> Load(
            ...
            PersistenceBeanException
    {
        return Load(entityClass, ProgramIndicatorsType.Realization);
    }
    ...
    public List<ProgramIndicators> GetByProject(String projectId)
            ...
            PersistenceBeanException
    {
        return GetByProject(projectId, ProgramIndicatorsType.Realization);
    }
}
