 ...
 * 
 */
public class DocumentsBean extends PersistenceEntityBean<Documents> {
	@SuppressWarnings("unchecked")
	public List<Documents> LoadByParams(DocumentsBeanBaseRequest baseRequest,
			String releaseFrom, 
	...
	@SuppressWarnings("unchecked")
	public List<Documents> LoadByParams(DocumentsBeanBaseRequest baseRequest,String releaseFrom,
	...
	@SuppressWarnings("unchecked")
	public List<Documents> LoadByParamsForCILAsse5(DocumentsBeanBaseRequest baseRequest,String releaseFrom, 
			List<Long> userids, String partnerId, String userRole)
	...
	@SuppressWarnings("unchecked")
	public List<Documents> LoadByParamsForPartner(DocumentsBeanBaseRequest baseRequest,
			String releaseFrom, 
			List<Long> userids, String partnerId, String userRole)
	...
	private void addPartnerRestriction(String partnerId, Criteria criterion)
		...
		if (partnerId != null && !partnerId.isEmpty()) {
			StringBuilder sb = new StringBuilder();
			sb.append("SELECT distinct cfpa.cfPartnerAnagraphs.user.id ");
			sb.append("FROM CFPartnerAnagraphProject cfpa ");
			sb.append("WHERE cfpa.deleted = false ");
			sb.append("AND cfpa.progressiveId = :progressiveId ");
			...
			criterion.add(Restrictions.in("user.id", listCfIds));
		}
	}

	public List<Documents> loadByCostDefinitionParams(Long projectId,Long progressiveId,
			Long phaseId)
	{
	 ...
	 * @throws PersistenceBeanException
	 */
	private ArrayList<Documents> getDocuments(Long projectId, Long progressiveId, Long phaseId,
			boolean isCostDocument) throws PersistenceBeanException
	{
		...
		return (ArrayList<Documents>) query.list();
	}

	public Documents LoadByDocumentId(Long documentId) throws PersistenceBeanException {
		Criteria criteria = PersistenceSessionManager.getBean().getSession().createCriteria(Documents.class);
		criteria.add(Restrictions.eq("id", documentId));
		criteria.add(Restrictions.eq("deleted", false));
		//System.out.println(criteria.uniqueResult());
		return (Documents) criteria.uniqueResult(); 
	}
