 ...
 *
 */
public class ProjectReportingsBean extends EntityProjectListBean<Reportings>
{
private List<SelectItem> reportings;
	...
	{
		List<Reportings> reps = BeansFactory.Reportings().loadByLevelAndRoles(ReportingsLevel.PROJECT, Arrays.asList(getCurrentUser().getRolesNames().split(", ")));
