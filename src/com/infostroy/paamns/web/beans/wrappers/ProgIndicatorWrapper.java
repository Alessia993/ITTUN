 ...
 *
 */
public class ProgIndicatorWrapper extends PhisicalInitializationToIndicators
{
	 public ProgIndicatorWrapper(ProgramIndicators indicator)
	    {
	        this.indicator = indicator;
	    }
	    
	    public ProgIndicatorWrapper(
